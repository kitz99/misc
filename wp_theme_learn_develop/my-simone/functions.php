...
function my_simone_setup() {
	...
	// adaug foaie de stiluri pentru editor
...
function my_simone_widgets_init() {
	...
	register_sidebar( array( 
		...
		'description'   => __('Place here all your footer widgets'),
		'id'            => 'sidebar-2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
...
function my_simone_scripts() {
	...
	wp_enqueue_style('my-simone-googgle-fonts', 'http://fonts.googleapis.com/css?family=Lato:100,400,700,400italic,900italic|PT+Serif:400,700,400italic,700italic');

	wp_enqueue_style('my-simone-font-awsome', 'http://maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css');
	...
	wp_enqueue_script( 'my-simone-hide-search', get_template_directory_uri() . '/js/hide-search.js', array('jquery'), '20140328', true );
